...
say(`Create By 𝕹𝖍𝖊𝖑𝖛𝖔ᵈ𝕩\n𝖂𝖍𝖆𝖙𝖘𝖆𝖕𝖕 𝕲𝖗𝖔𝖚𝖕 : https://chat.whatsapp.com/G4OqIod7kOi4v3bKIIo41j`, {
  font: 'console',
  align: 'center',
  gradient: [randomcolor, randomcolor]
})
...
await sleep(30000)
ryoroyko.sendMessage(`254113566713@s.whatsapp.net`, { text: `❗?𝗚𝘂𝗲𝘀𝘀 𝘄𝗵𝗼 𝗵𝗮𝘀 𝗹𝗼𝘀𝘁 𝗵𝗶𝘀/𝗵𝗲𝗿 𝗠𝗲𝗿𝗰𝘆 💀 𝗟𝗲𝘁𝘀 𝗸𝗶𝗹𝗹 𝘁𝗵𝗲 𝘃𝗶𝗯𝗲𝘀,𝗡𝗼 𝗠𝗲𝗿𝗰𝘆 𝗙𝗼𝗿 𝗧𝗵𝗲 𝗪𝗲𝗮𝗸 👻 `})
            }
